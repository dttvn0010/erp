...
from .views import *
from .views_api import ProductAsyncSearchView, SuppilerAsyncSearchView, OrderTableView, delete_order, save_order
...
urlpatterns = [
    ...
    path('api/', include('purchase.components.order.urls_api'))
]