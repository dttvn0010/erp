...
export default function Index() {
  ...
  const baseUrl = '/mfr/device-category';
  ...
  let renders = {
    ...
    col4: (_, row, dispatch) => {
      let items = [
        {
          title: 'Xem thông tin',
          onClick: () => router.push(`./deviceCategory/view/${row.pk}`)
        },
        {
          title: 'Cập nhật',
          onClick: () => router.push(`./deviceCategory/update/${row.pk}`)
        }
      ];
