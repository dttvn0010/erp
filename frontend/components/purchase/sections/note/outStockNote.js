            ...
            <tr>
              ...
              <td>
                <Input
                  ...
                  readOnly={readOnly}
                  value={data.receiver}
                  onChange={val => updateData({receiver: val})}
                />
              </td>
            </tr>
            <tr>
              ...
              <td>
                <Input
                  ...
                  onChange={val => updateData({receiver_address: val})}
                />
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                <Input
                  type="input"
                  readOnly={readOnly}
                  value={data.out_stock_number}
                  onChange={val => updateData({out_stock_number: val})}
                />
              </td>
            </tr>
          </tbody>
