      ...
      <div className="col-8 p-2">
        ...
        <table className="table">
          <tbody>
            ...
            <tr>
              ...
              <td>
                <Input
                  ...
                  rows="2"
                  readOnly={readOnly}
                  value={data.payer_address}
                  onChange={val => updateData({payer_address: val})}
                />
              </td>
            </tr>
            <tr>
              ...
              <td>
                <Input
                  ...
                  onChange={val => updateData({payer_account: val})}
                />
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <th>Đơn vị giao đại lý:</th>
              <td>
                <Input
                  type="input"
                  readOnly={readOnly}
                  value={data.agent}
                  onChange={val => updateData({agent: val})}
                />
              </td>
            </tr>
            <tr>
