...
import { NAME_SPACE } from 'redux/reducers/stock/import/formReducer';

const itemName = 'phiếu nhập kho';

export default function ImportForm({id, update, readOnly}){
  const baseUrl = '/stock/import';
  const backUrl = (update || readOnly)? '../' : '../import';
  ...
  return (
    <Card
      title={title}
      body={
        <form id="fmt" onSubmit={saveImport}>
