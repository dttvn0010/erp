...
import { NAME_SPACE } from 'redux/reducers/stock/export/formReducer';

const itemName = 'phiếu xuất kho';

export default function ExportForm({id, update, readOnly}){
  const baseUrl = '/stock/export';
  const backUrl = (update || readOnly)? '../' : '../export';
          ...
          <table className="table mt-3">
            <thead>
              <tr>
                ...
                <th style={{width: "35%"}}>Kho</th>
                <th style={{width: "35%"}}>Hàng hoá</th>
